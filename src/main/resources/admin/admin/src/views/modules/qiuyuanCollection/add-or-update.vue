    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="qiuyuanCollectionTypes">
                        <el-select v-model="ruleForm.qiuyuanCollectionTypes" :disabled="ro.qiuyuanCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in qiuyuanCollectionTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="类型" prop="qiuyuanCollectionValue">
                        <el-input v-model="ruleForm.qiuyuanCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    qiuyuanId: false,
                    yonghuId: false,
                    qiuyuanCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    qiuyuanId: '',
                    yonghuId: '',
                    qiuyuanCollectionTypes: '',
                    insertTime: '',
                },
                qiuyuanCollectionTypesOptions : [],
                qiuyuanOptions : [],
                yonghuOptions : [],
                rules: {
                   qiuyuanId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=qiuyuan_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.qiuyuanCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`qiuyuanCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.qiuyuanCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
