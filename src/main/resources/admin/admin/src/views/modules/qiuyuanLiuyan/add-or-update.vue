    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="qiuyuanLiuyanText">
                        <el-input type="textarea"  :readonly="ro.qiuyuanLiuyanText" v-model="ruleForm.qiuyuanLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.qiuyuanLiuyanText" label="留言内容" prop="qiuyuanLiuyanText">
                            <span v-html="ruleForm.qiuyuanLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.qiuyuanId = true;//球员
                this.ro.yonghuId = true;//用户
                this.ro.qiuyuanLiuyanText = true;//留言内容
            }else{
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`qiuyuanLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.qiuyuanLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
