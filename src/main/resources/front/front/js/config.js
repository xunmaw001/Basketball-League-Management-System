...
var centerMenu = [
    ...
    ,{
        name: '球队收藏',
        url: '../qiuduiCollection/list.html'
    }
    ,{
        name: '球员收藏',
        url: '../qiuyuanCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '球队',
        url: './pages/qiudui/list.html'
    },
    {
        name: '球员',
        url: './pages/qiuyuan/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/lanqiulianmengguanlxitong/admin/dist/index.html#/login";
