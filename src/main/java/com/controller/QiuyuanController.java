    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(qiuyuan !=null){
            ...
            if(qiudui != null){
            BeanUtils.copyProperties( qiudui , view ,new String[]{ "id", "createTime", "insertTime", "updateTime"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
    ...
    */
    ...
    public R save(@RequestBody QiuyuanEntity qiuyuan, HttpServletRequest request){
        ...
        Wrapper<QiuyuanEntity> queryWrapper = new EntityWrapper<QiuyuanEntity>()
            ...
            .eq("sex_types", qiuyuan.getSexTypes())
            .eq("qiuyuan_shengao", qiuyuan.getQiuyuanShengao())
            .eq("qiuyuan_tizhong", qiuyuan.getQiuyuanTizhong())
            .eq("qiuyuan_age", qiuyuan.getQiuyuanAge())
            .eq("qiuyuan_jinqiushu", qiuyuan.getQiuyuanJinqiushu())
            .eq("qiuyuan_zhugong", qiuyuan.getQiuyuanZhugong())
            .eq("qiuyuan_jiangbei", qiuyuan.getQiuyuanJiangbei())
...
//                            qiuyuanEntity.setQiuyuanName(data.get(0));                    //球员姓名 要改的
//                            qiuyuanEntity.setQiuyuanPhoto("");//详情和图片
//                            qiuyuanEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            qiuyuanEntity.setQiuyuanShengao(data.get(0));                    //身高 要改的
//                            qiuyuanEntity.setQiuyuanTizhong(data.get(0));                    //体重 要改的
//                            qiuyuanEntity.setQiuyuanAge(data.get(0));                    //年龄 要改的
//                            qiuyuanEntity.setQiuyuanJinqiushu(Integer.valueOf(data.get(0)));   //进球数 要改的
//                            qiuyuanEntity.setQiuyuanZhugong(Integer.valueOf(data.get(0)));   //助攻数 要改的
//                            qiuyuanEntity.setQiuyuanJiangbei(Integer.valueOf(data.get(0)));   //获得奖杯 要改的
//                            qiuyuanEntity.setQiuyuanTypes(Integer.valueOf(data.get(0)));   //球员位置 要改的
//                            qiuyuanEntity.setQiuduiId(Integer.valueOf(data.get(0)));   //所属球队 要改的
