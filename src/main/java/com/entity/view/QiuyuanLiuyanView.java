...
public class QiuyuanLiuyanView extends QiuyuanLiuyanEntity implements Serializable {
	...
	public QiuyuanLiuyanView() {

	}

	public QiuyuanLiuyanView(QiuyuanLiuyanEntity qiuyuanLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, qiuyuanLiuyanEntity);
