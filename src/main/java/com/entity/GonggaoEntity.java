...
public class GonggaoEntity<T> implements Serializable {
     ...
     * 篮球资讯名称
     */
    @ColumnInfo(comment="篮球资讯名称",type="varchar(200)")
     ...
     * 篮球资讯图片
     */
    @ColumnInfo(comment="篮球资讯图片",type="varchar(200)")
     ...
     * 篮球资讯类型
     */
    @ColumnInfo(comment="篮球资讯类型",type="int(11)")
     ...
     * 篮球资讯详情
     */
    @ColumnInfo(comment="篮球资讯详情",type="longtext")
